...
def main():
    ...
    st.title("Techionik Deep learning with Ultralytics")
    st.subheader(":yellow[Works only with Tactical Camera footage]")
    ...
    # Set max_upload_size to allow files larger than 200MB
    ...
    demo_vid_paths={
        "Demo 1":r'C:\Users\SaadSuleman\Downloads\Football-Analytics-with-Deep-Learning-and-Computer-Vision-master (1)\Streamlit web app\demo_vid_1.mp4',
        "Demo 2":r'C:\Users\SaadSuleman\Downloads\Football-Analytics-with-Deep-Learning-and-Computer-Vision-master (1)\Streamlit web app\demo_vid_2.mp4'
    }
    ...
    if start_detection and not stop_detection:
        ...
        # Start the timer when detection begins
        start_time = time.time()
        while time.time() - start_time <= 30:  # 30-second timer
    ...
    #git clone https://github.com/Hmzbo/Football-Analytics-with-Deep-Learning-and-Computer-Vision.git Football-Analytics-with-Deep-Learning-and-Computer-Vision_new
    #cd Football-Analytics-with-Deep-Learning-and-Computer-Vision
    # set KMP_DUPLICATE_LIB_OK=TRUE
    #streamlit run "C:\Users\SaadSuleman\Downloads\Football-Analytics-with-Deep-Learning-and-Computer-Vision-master (1)\Streamlit web app\main.py"
